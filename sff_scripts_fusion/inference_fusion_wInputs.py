...
if __name__ == "__main__":
    ...
    parser.add_argument('-ip', '--input_path', type=str, default='../data/test/test_cremib/')
    parser.add_argument('-t', '--txt_file', type=str, default='cremib_25sff')
    parser.add_argument('-op', '--output_path', type=str, default='../results/cremib')
    ...
    f_txt.close()
    interp_path = os.path.join(args.output_path, args.txt_file + '_interp')    # VFI
    # sff_path = os.path.join(args.input_path, args.txt_file + '_degradation')
    # sff_path = os.path.join(args.input_path, args.txt_file + '_BMcorrect')
    sff_path = os.path.join(args.input_path, args.txt_file + '_GFcorrect')
    output_path = os.path.join(args.output_path, args.txt_file + '_' + args.model_id+'_GF')
