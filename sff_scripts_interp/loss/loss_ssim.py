...
if __name__ == "__main__":
    ssim_loss = SSIMLoss()
    # img1 = np.random.random((4, 3, 256, 256)).astype(np.float32)
    img1 = np.zeros((4, 3, 256, 256), dtype=np.float32)
    img2 = np.random.random((4, 3, 256, 256)).astype(np.float32)
    img1 = torch.tensor(img1)#.to('cuda:0')
    img2 = torch.tensor(img2)#.to('cuda:0')
